...
const ENDPOINTS_HARDCODED = [
  ...
  { group:"OSA (Sidecar)", server:"sidecar", method:"GET",  path:"/api/osa/model", desc:"OSA brain pin: pinned model (null = auto), mode, valid registry choices with availability + reason", params:[] },
  { group:"OSA (Sidecar)", server:"sidecar", method:"POST", path:"/api/osa/model", desc:"Pin OSA's brain to a registry model id or 'auto' (durable; 422 unknown, 409 unavailable-with-reason)", params:[{name:"body",_in:"body",type:"json",required:true,hint:'{"model":"claude-sonnet-4-6"}'}] },
